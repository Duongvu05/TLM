...
with open("data_train_b4e/bert4eth_trans3.pkl", "rb") as f:
    trans_seq = pkl.load(f)


with open("/home/hainguyen/TLmGNN/gen_b4e_seq/raw_data/phisher_account.txt", "r") as f:
...
with open("data_train_b4e/bert4eth_trans4.pkl", "wb") as f:
