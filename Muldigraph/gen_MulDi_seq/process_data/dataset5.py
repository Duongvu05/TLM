...
with open("data_train_MulDi/transactions3.pkl", "rb") as f:
    trans_seq = pkl.load(f)


with open("/home/hainguyen/TLmGNN/Muldigraph/gen_MulDi_seq/raw_data/phisher_accounts.txt", "r") as f:
...
with open("data_train_MulDi/transactions4.pkl", "wb") as f:
