...
with open('data_train_MulDi/transactions4.pkl', 'rb') as file:
    transactions_dict = pickle.load(file)

with open('data_train_MulDi/address_to_idx.pkl', 'rb') as file:
...
save_to_tsv_train_dev(validation_data, 'trans_sentence/validation.tsv')
save_to_tsv_test(test_data, 'trans_sentence/test.tsv')

print("Files saved: train.tsv, validation.tsv, test.tsv")