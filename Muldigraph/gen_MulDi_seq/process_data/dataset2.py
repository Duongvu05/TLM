...
with open("data_train_MulDi/eoa2seq.pkl", "rb") as f:
...
for address, transactions in tqdm(trans_seq.items()):
    ...
    for transaction in transactions:
        modified_transaction = [transaction[i] for i in range(len(transaction)) if i not in [4, 5]]
...
with open('data_train_MulDi/adj.pkl', 'wb') as f:
    pkl.dump(adj, f)

with open('data_train_MulDi/address_to_idx.pkl', 'wb') as f:
    pkl.dump(address_to_idx, f)

with open('data_train_MulDi/idx_to_address.pkl', 'wb') as f:
    pkl.dump(idx_to_address, f)

with open('data_train_MulDi/transactions1.pkl', 'wb') as f:
