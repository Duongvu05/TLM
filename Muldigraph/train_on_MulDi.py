...
data_dir = f"gen_MulDi_seq/data_train_MulDi"
...
with open("/home/hainguyen/TLmGNN/Muldigraph/gen_MulDi_seq/data_train_MulDi/adj.pkl", "rb") as f:
    gcn_adj = pkl.load(f)
...
abnormal_prompt = torch.load("/home/hainguyen/TLmGNN/abnormal_prompt.pt").detach().to(device)

if args.model_name == "BertGCN":
    model = BertGCN(model, abnormal_prompt, m=m)
